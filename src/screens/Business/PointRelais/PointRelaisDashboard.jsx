        ...
        <div className="px-6 pt-6 pb-20 space-y-5">
          ...
          <div className="bg-purple-600 rounded-xl p-4 text-white">
            <div className="flex items-center justify-between mb-3">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-purple-50 mt-0.5">{stats.colisAujourdhui} colis</p>
              </div>
              <Store className="w-10 h-10 opacity-80 flex-shrink-0 ml-2" />
            </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className={`text-xs px-2 py-0.5 rounded-full ${
                          colis.statut === 'Prêt à retirer' ? 'bg-purple-100 text-purple-700' : 'bg-yellow-100 text-yellow-700'
                        }`}>
                          {colis.statut}
                        </span>
                      </div>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-purple-900 text-sm mb-1">Rémunération</p>
                <p className="text-xs text-purple-700">Vous gagnez 150 F par colis stocké et remis au destinataire</p>
              </div>
            </div>
          </div>
        </div>
